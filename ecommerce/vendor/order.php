...
<a href='remove_order.php?oid=$oid&status=1' > <button class='btn btn-success'>Approve Order</button>  </a>
<a href='remove_order.php?oid=$oid&status=-1'> <button class='btn btn-danger'>Reject Order</button>  </a>
<br>
<br>
